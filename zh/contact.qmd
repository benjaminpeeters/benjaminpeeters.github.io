...
感谢您的关注！无论您对我的研究有疑问、有合作想法，还是只是想联系我，我都很乐意收到您的来信。
</p>
...
<strong>代码相关问题？</strong>请使用 <a href="https://github.com/benjaminpeeters" target="_blank">GitHub</a> 提交问题、错误报告或进行技术讨论。
</p>
</div>
...
document.getElementById('contact-form').addEventListener('submit', async function(e) {
  ...
  try {
    ...
    if (response.ok) {
      statusDiv.textContent = '感谢您的留言！我会尽快回复您。';
    ...
    statusDiv.textContent = '抱歉！发送消息时出现问题。请重试或通过 GitHub 联系我。';
